...
public class Ventana_Conf_Anexo extends JFrame {
	// ======================================= MVC
	// ==================================
...
//BOTON SI
		...
		lblSIBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(miModelo.getAnexoSeleccionado()==0) {
					miModelo.anularAnexo(miModelo.getNombreTablaAnexo(),miModelo.getNombreAnexo(),miModelo.getCifEmpresa());
					setVisible(false);
				}else if(miModelo.getAnexoSeleccionado()==1 ||miModelo.getAnexoSeleccionado()==3||miModelo.getAnexoSeleccionado()==4||miModelo.getAnexoSeleccionado()==5) {
					miModelo.anularAnexo2(miModelo.getNombreTablaAnexo(),miModelo.getNombreAnexo(),miModelo.getCifEmpresa());
					setVisible(false);
				}else if(miModelo.getAnexoSeleccionado()==2) {
					miModelo.anularAnexo2_2(miModelo.getNombreTablaAnexo(),miModelo.getNombreAnexo(),miModelo.getCifEmpresa());
					setVisible(false);
				}
